...
const serialize = function (runtime, targetId) {
    ...
    // 装配设备扩展信息
    const peripheral = Object.create(null);
    peripheral.tabVisible = runtime.peripheralExtensions.tabVisible;
    peripheral.id = runtime.peripheralExtensions.id;
    peripheral.blocksXML = runtime.peripheralExtensions.blocksXML;
...
const deserialize = function (json, runtime, zip, isSingleSprite) {
    ...
    // 载入设备扩展信息
    if (json.peripheral) {
        runtime.peripheralExtensions.tabVisible = json.peripheral.tabVisible;
        runtime.peripheralExtensions.id = json.peripheral.id;
        runtime.peripheralExtensions.blocksXML = json.peripheral.blocksXML;
    }
